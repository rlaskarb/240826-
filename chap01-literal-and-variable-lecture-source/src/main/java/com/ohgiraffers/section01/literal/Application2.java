...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println('a' + 1); // 아스키 코드 상에 a 는 97이다. 근데 이건 구닥다기 방법,
        // 한 번에 알 수 있는 방법은 나중에 알려주실 예정.
        /* 컴퓨터는 문자 인식하지 못하고 숫자로만 인식을 할 수 있기
        때문에 모든 문자는 대응이 되는 숫자들이 존재한다. (아스키 코드 & 유니코드) */
...
//        System.out.println("hello" % "world");
        ...
        /* 중요. 문자열이 포함된 연산의 결과는 다른 형태의 값(숫자, 문자, 논리)
        들도 문자열로 취급하여 이어 붙이기(합치기) 결과가 나오게 된다. */
