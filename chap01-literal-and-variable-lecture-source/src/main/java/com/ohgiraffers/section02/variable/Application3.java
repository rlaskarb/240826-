...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        *  변수의 명명 규칙
        *  1. 컴파일 에러를 발생시키는 규칙
        *  2. 컴파일 에러를 발생시키지는 않지만, 개발자들끼리 암묵적 규칙
        * */
...
//
//        int for = 20;
//        int if = 20; // 쉽게 구분하는 방법은 글자의 색이 다르다.

        /*목차. 1-3 변수명은 대소문자를 구분한다. */
        int AGE = 20; // 위에서 우리가 만든 age 와는 다른 녀석이다.
        int True = 20; // 예약어 true 와는 다른 녀석이다.

        /* 목차. 1-4. 변수명은 숫자로 사작할 수 없다. */
//        int 1age = 50;
        int age1 = 50;
...
//        int sh@op = 20;
        ...
        int dsjfklsjelkqwjlkjflkejlfkjdfklqwjkhajkdakjsh;
        ...
        * */
        ...
        int nimAge = 20;
        String user_name = "김남규"; // java 에서는 하지 않는다.
        String userName = "김남규"; // 이게 java 에서 옳바른 표기법이다.

        /*목차. 2-3 변수명을 한글로 지어도 에러는 없다. 하지만 권장하지 않는다. */
        int 나이 = 10;

        /*목차. 2-4. 변수 안에 저장 된 값이 어떤 의미를 가지는 지 명확히 펴현하자!! */
        String s = "김남규";
        String name = "김남규";
