...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *  - 변수를 이용하여 코드를 작성하면, 값을 변경할 때도 보다 편하게 변경할수 있다.
        ...
        *  - 중요. 변하는 값을 저장하기 위한 공간 !!!!!!!!!!! */
        ...
        System.out.println("=============변수에 자장한 값 재사용 테스트 ====================");
        ...
        // int point = 100; < (=)대입연산자 오른쪽은 항상 값이다 !!!!!!!

        System.out.println("1번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("2번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("3번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("4번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("5번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("6번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("7번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("8번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("9번 고객에게 " + point + "포인트 지급혀였습니다.");
        System.out.println("10번 고객에게 " + point + "포인트 지급혀였습니다.");
