...
public class Application {
    public static void main(String[] args) {
        ...
        *   1-2 공통적으로 사영하는 코드가 부모클래스에게 존재하게 되면
        *       수정사항이 생길 시 부모 클래스만 수정을 해도 전체적으로 사용가능 (유지보수성 증가)
        * 2. 클래스 간의 계층 관계가 생기며 다형성 문법의 토대가 된다.
        *
        * 필기.
        *  하지만 상속으로 인한 단점 존재
        *   1. 부모클래스의 기능을 추가/변경 할 시 자식 클래스가 정상적으로 동작하는지 예측 어려움.
        *      상속 구조가 복잡해 질 수록 그 영향에 대한 예측이 힘들어지며
        *      이러한 복잡한 구조는 오히려 유지 보수성을 악화 시킬 수 있다.
        *
...
//        fireCar.isRunning();
        ...
        /* 목차 3. 소방차가 경적 소리가 너무 노잼임. */
         /* 꼬부기를 구매해서 매달아보자.*/

        /*필기 상속은 물려받는 것 뿐만 아니라 확장도 할수있다.*/
        fireCar.speatWater();


        System.out.println("========================");
        /* 목차 4. 경운기 만들기 ->경적이 없는 차 */
