package com.ohgiraffes.section05.overloading;

public class OverloadingTests {
    /*학습목표 오버로딩에 대해 이해할 수 있다.*/
    ...
    * 매소드를 관리하는 기술을 오버로딩(overloading) 이라고 한다.
    * */
    ...
    * test(int num) <= 이 부분이 메소드의 시그니처 이다.
    * */

    public void test(){}

    //메소드의 시그니처가 같기 때문에 컴파일 에러 발생
//    public void test(){}


    //접근 제한자를 바꾸어도 메소드 시그니처가 같기 때문에 오류 발생
//    private void test(){}
