...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 어떤 값을 쓸 지 모르니 다 준비해두는 선물 세트 같은 느낌이다.
        * private 캡슐화가 된 필드와 필드의 값을 수정 할 수 있는
        * 설정자(setter),필드에 값을 접근할 수 있는 접근다 (getter) 로
        ...
        * */
        ...
        member.setAge(36);
        member.setGender('남');
        member.setHeight(170.52);
        member.setWeight(63.2);
