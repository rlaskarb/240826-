...
public class UserDTO {
    ...
    private String pwd;
    private String name;
    private LocalDateTime enrollData; //필드로 다른 클래스 자료형도 사용가능 (회원가입일시)
     ...
     * 2. 매개변수 있는 생성자의 경우 매개 변수로 전달 받은 값으로 필드
     ...
     * }
     * 생성자 작성시 주의점!!!
     * 1. 생성자 메소드는 반드시!!!! 클래스 이름과 동일 해야 한다.(대/소문자까지)
    ...
    public UserDTO(String id, String pwd, String name){
        ...
        * -동일한 이름을 가진 생성자 혹은 메소드를 여려 개 작성할 수 있다는 뜻이다.
        * - 오버로딩(overloading)
        * */
        ...
        this.pwd = pwd;
        this.name = name;
        System.out.println("UserDTO 의 매개변수가 있는 생성자 호출!!");
    }
    ...
    public UserDTO(String id, String pwd, String name, LocalDateTime enrollData){
        ...
        System.out.println("모오든 필드 생성자 호출!!");
    }
