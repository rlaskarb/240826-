...
public class Application3 {
    public static void main(String[] args) {
        ...
        * 이중 가장 높은 성능을 보이는 것은 순수 배열의 복사를 위해
        * 만들어진 arraycopy() 메소드 이며,
        * 가장많이(가장빠름) 사용 되는 방식은 copyOf() 메소드 이다.
        ...
        * */
        ...
        /*목차 2. Object 의 clone()을 이용한 값 복사*/
        int[] copArr2 =originArr.clone();

        print(copArr2);

        /*목차 3. System 의 arraycopy() 를 이용한 복사 */
        ...
        * */
        ...
        /*목차 4.Arrays 의 copyOf() 메소드를 이용한 복사 */ /* index <----이것만 기억해도 성공 */
