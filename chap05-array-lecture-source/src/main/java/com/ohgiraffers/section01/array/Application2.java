...
public class Application2 {
    public static void main(String[] args) {
        /*학습목표 배열의 사용을 방법을 익효 배열을 사용할 수 있다.*/
        ...
        /*필기
         * 자료형[] 변수명;<-- 이 선언문을 많이 사용함
         * 자료형 변수형[];
         * */

        /*필기 선언 stack 영역에 배열의 주소를 보관할수 있는 공관을 만드는것.*/
        int[] iarr; //<--- 이 선언문을 많이 사용함.
        char carr[];
        ...
        //iarr = new int[]; 공간을 지정하지 않으면 에러발생
        iarr = new int[5];
        carr = new char[10];

        //int x ; x=10;

        /*필기 이렇게 선언과 동시에 할달을 할 수도 있다.*/
        int[] iarr2 = new int[5];
         ...
         * 로 바꾸어주는 메소드 동일 객체인 지 비교할 때 주로 쓰인다. ex)주민번호로 이해하는게 좋을듯.
         * */
        ...
        * 그래서 String 경우에는 문자열의 길이를 메소드로 제공하고 있*/
        ...
        *   새로운 공간 을 할당해서 주소값을 레퍼런스변수에 덮어 쓴 것이다.
        *   */

        /* */
        darr =new double[10];
        System.out.println("수정후 darr 의 hashCode : " + darr.hashCode());
        System.out.println("수정후 darr 의 길이 : " + darr.length);
