...
public class Application2 {
    public static void main(String[] args) {
        /*학습목표 Linked 에 대해 이해할 수 있따.*/

        /*필기
        * LinkedList
        * ArrayList 가 배열을 이용해서 발생할 수 있는 성능적인 단점을
        * 보완 하고자 나온 클래스이다.
        * 내부에 이중연결리스트로 구현되어 있다.
        ...
        * 요소의 저장과 삭제시 다음 요소를 가리키는 참조 링키만
        ...
        * 이전 요소로 접근은 어렵다.*/
        ...
        /*필기
        * 이중연결리스트
        * 단일연결리스트는 다음 요소만 링크(참조)하는 반면, 이중연결리스트는
        * 이전 요소도 링크하여 이전 요소에 대한 접근도 쉽게 고안된 자료구조이다.
        * LinkedList 가 이중연결리스트를 구현한 것이며, List 인터페이스를
        * 상속 받아서 구현되어 ArrayList 와 사용방법이 거의 유사하다.
        * 하지만 내부적으로 요소를 저장하는 방식이 다른다는 것은 인지해야 한다!!
        * */
