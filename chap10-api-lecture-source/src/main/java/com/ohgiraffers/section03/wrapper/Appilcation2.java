...
public class Appilcation2 {
    public static void main(String[] args) {
        /*학습목표 문자열 파싱(parsing) 에 대해 이해할 수 있다.*/

        /*필기
        * parsing 이란, 문자열(String) 값을 기본 자료형 값으로 변경하는것.
        * */

        /*필기
        * 기본 자료형은 넘겨진 문자열을 스스로 바꿀 수있는 기능이 없다.
        ...
        * */
        ...
        /*char c = Character.parse,, Character 는 parsing 제공하지 않는다.
