...
public class CharacterManager {
    ...
    public void characterManager() {
        ...
        characters[1] = new Character_DTO(0, "전사", 70, 30,0);
        characters[2] = new Character_DTO(0, "궁수", 70, 30,0);
        characters[3] = new Character_DTO(0, "마법사", 70, 30,0);
        characters[4] = new Character_DTO(0, "도적", 70, 30,0);
