...
public class D_switch {
    public void testSwitchStatement(){
        ...
        *       default : case 모두 해당하지 않는 경우 실행구문; break;*/
        ...
        * */
        ...
        /*목차 1 문제
        * 정수 두 개와 연산기호 문자를 입력 받아
        * 두 숫자의 연산 결과를 출력해보는 계산기 만들기
        * */
...
//        switch (selectDrink){
//            case "s":
//                System.out.println(" 사이다를 선택 했습니다.");
//                price= 1300;
//            case "b":
//                System.out.println(" 맥주를 선택 했습니다.");
//                price= 1700;
//            case "so":
//                System.out.println("소주를 선택 했습니다.");
//                price= 2300;
//            case "h":
//                System.out.println("환타를 선택 했습니다.");
//                price = 1300;
//        }
//
//        System.out.println( price + "원을 투입 해주세요~");
        ...
        System.out.println( orderMenu + "를 선택 하셨습니다.~");
        System.out.println( price + "원을 투입 했습니다.~");
    }
